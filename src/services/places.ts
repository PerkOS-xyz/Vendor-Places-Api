import type { PlaceSearchRequest, PlaceSearchResponse, Place } from "../types/index.js";
import { googlePlacesApiKey } from "../config/x402.js";

/**
 * Google Places Text Search Service
 * Wrapper around Google Places API with optimization for AI agents
 */
export class PlacesService {
   ...
   * @returns Formatted place search results
   */
